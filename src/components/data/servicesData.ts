...
export const services = [
  {
    ...
    translations: {
      ...
      uk: {
        ...
        description:
          "Розробляю сайти під ваші потреби — без шаблонів, лише чистий і якісний код.",
      },
      pl: {
        letter: "T",
  ...
  },
  {
    ...
    translations: {
      ...
      uk: {
        ...
        description:
          "Створюю швидкі, масштабовані та SEO-оптимізовані веб-додатки.",
      },
      pl: {
        letter: "R",
        title: "Rozwój w React i Next.js",
        description:
          "Buduję szybkie, skalowalne i zoptymalizowane pod SEO aplikacje internetowe.",
      },
    },
  },
  {
    ...
    translations: {
      en: {
        ...
        description:
          "Whether on mobile or desktop — your website will look perfect everywhere.",
      },
      uk: {
        letter: "А",
  ...
  },
  {
    ...
    translations: {
      ...
      uk: {
        ...
        description:
          "Підключаю зовнішні API або інтегрую CMS для зручного керування контентом.",
      },
      pl: {
        letter: "I",
  ...
  },
  {
    ...
    translations: {
      en: {
        ...
        description:
          "I stay available for updates, support, or new features even after launch.",
      },
      uk: {
        letter: "П",
        title: "Підтримка та супровід",
        description:
          "Залишаюсь на зв'язку після запуску — оновлення, підтримка, нові функції.",
      },
      pl: {
        letter: "W",
        title: "Wsparcie i utrzymanie",
        description:
          "Pozostaję dostępny po uruchomieniu — aktualizacje, wsparcie, nowe funkcje.",
      },
    },
  },
];
